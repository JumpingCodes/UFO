...
public class Ufospiel{
    ...
    public static ArrayList<Asteroid> ArrayList = new ArrayList<Asteroid>();
    ...
    public Ufospiel(){
        ...
        //dasUfospiel = new Ufospiel();

        ArrayList.add(new Asteroid(dasUfo,derSchuss, dasUfospiel));
        ArrayList.add(new Asteroid(dasUfo,derSchuss, dasUfospiel));
        ArrayList.add(new Asteroid(dasUfo,derSchuss, dasUfospiel));

        fuehreAus();
    }
    public static void destroy(Object X){ArrayList.remove(X);}
